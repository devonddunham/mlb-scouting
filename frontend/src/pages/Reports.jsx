    ...
    try {
      const res = await fetch("/api/reports", {
        ...
        body: JSON.stringify({
          ...
          scout_id: parseInt(form.scout_id),
      ...
      {showForm && (
        <div style={{
          ...
          <div style={{
            ...
            <label style={{ display: "block", marginBottom: "6px", fontWeight: "bold" }}>Player</label>
            <select
              name="player_id"
            ...
            <label style={{ display: "block", marginBottom: "6px", fontWeight: "bold" }}>Scout</label>
            <select
              name="scout_id"
              value={form.scout_id}
              onChange={handleChange}
            ...
            <label style={{ display: "block", marginBottom: "6px", fontWeight: "bold" }}>Year</label>
            <input
              type="number"
              name="year"
              value={form.year}
